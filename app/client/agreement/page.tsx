...
// Ported from app/portal/agreement/page.tsx as part of the /portal -> /client
// merge (Batch 1). Same data/API calls as the portal original; chrome
// (company identity header, notifications, sign-out) now comes from
// app/client/layout.tsx instead of being reimplemented here, so this page
// only renders its own page-specific header + content.

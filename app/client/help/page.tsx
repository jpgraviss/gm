...
// Ported from app/portal/help/page.tsx as part of the /portal -> /client
// merge (Batch 1). Same data/API calls as the portal original. The portal
// version had its own top bar (Help Center brand + "Contact Support" link
// to /portal/tickets) duplicating chrome that app/client/layout.tsx now
// owns (company identity header + the CLIENT_ROUTES nav strip, which
// includes a link back to this page). That bar is dropped here; the
// in-page "Help Center" breadcrumbs still work via local view state
// (no navigation needed), and "Contact Support" links now point at
// /client, since Support lives as a tab on the main client dashboard
// rather than a standalone /portal/tickets route.
        ...
        <>
          <div className="py-8 sm:py-16 text-center px-4" style={{ background: 'linear-gradient(135deg, #015035 0%, #01804f 100%)' }}>
            ...
            <div className="mt-5">
              <Link
                href="/client"
                className="inline-flex items-center gap-1.5 px-4 py-2 text-xs sm:text-sm font-medium text-white/90 rounded-lg border border-white/30 hover:bg-white/10 transition-colors"
              >
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          ...
          {feedback === 'no' && (
            <p className="text-xs text-gray-500 mt-3">
              ...
              <Link href="/client" className="text-[#015035] font-medium hover:underline">
                Contact support
              </Link>{' '}

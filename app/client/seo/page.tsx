...
// Ported from app/portal/seo/page.tsx as part of the /portal -> /client
...
// .last_updated/.strategy for every enabled service, but nothing
// client-facing ever read it. Since the panel is genuinely service-agnostic
// (it renders for every service in ALL_SERVICES — SEO, PPC, Web Design,
// Social Media, Email Marketing, Content Creation, Sales Training,
// Marketing Strategy — not just SEO), the general fix lives in the
// Insights tab of app/client/page.tsx, which is the one place a client
// sees cross-service data regardless of which services they have. See the
// comment there for the read-only rendering of this data.
      ...
      <div className="px-4 py-4 sm:px-8 sm:py-6 border-b border-gray-200 bg-white">
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-1.5 text-xs text-gray-400">
            <Calendar size={12} />
            Last Updated: {formatDisplayDate(strategy.lastUpdated)}
          </div>
        </div>
      </div>

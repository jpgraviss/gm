...
// Everything here is invented for illustration — no real client names, no
// real dollar figures or pricing structure, no real anything. Dollar
// amounts are deliberately non-round (not the kind of number a real rate
// card would use) so nothing here could be mistaken for actual pricing.
// Do not add real data or real prices here.
...
export const DEALS: DemoDeal[] = [
  { company: 'Anchor Outdoor', initials: 'AO', value: 4340, stage: 'prospect', lastActivity: '2 days ago' },
  { company: 'Wayfinder Coffee', initials: 'WC', value: 1760, stage: 'prospect', lastActivity: '5 days ago' },
  { company: 'Coastal Fitness Co.', initials: 'CF', value: 2480, stage: 'prospect', lastActivity: 'Today' },
  { company: 'Highline Roofing', initials: 'HR', value: 3260, stage: 'qualified', lastActivity: 'Yesterday' },
  { company: 'Northgate Veterinary', initials: 'NV', value: 1980, stage: 'qualified', lastActivity: '3 days ago' },
  { company: 'Riverside Dental', initials: 'RD', value: 2690, stage: 'proposal', lastActivity: 'Today' },
  { company: 'Blue Ridge Auto', initials: 'BA', value: 5120, stage: 'proposal', lastActivity: '1 day ago' },
  { company: 'Meridian HVAC', initials: 'MH', value: 6280, stage: 'negotiation', lastActivity: 'Today' },
  { company: 'Palmetto Realty', initials: 'PR', value: 2970, stage: 'closed_won', lastActivity: '1 week ago' },
  { company: 'Sunbelt Landscaping', initials: 'SL', value: 2740, stage: 'closed_won', lastActivity: '2 weeks ago' },
]
...
export const PROPOSALS: DemoProposal[] = [
  ...
  },
  {
    ...
    monthly: '$4,480/mo',
    items: [
      { name: 'Paid Search & Social', detail: 'Managed ad spend + creative', price: '$2,480/mo' },
      { name: 'SEO Management', detail: 'Ongoing optimization & reporting', price: '$1,360/mo' },
      { name: 'Reputation Management', detail: 'Review monitoring & response', price: '$640/mo' },
    ],
  },
  {
    id: 'riverside',
    ...
    monthly: '$1,440/mo',
    items: [
      { name: 'SEO Management', detail: 'Ongoing optimization & reporting', price: '$980/mo' },
      { name: 'Reputation Management', detail: 'Review monitoring & response', price: '$460/mo' },
    ],
  },
]
...
export const PORTAL_CLIENT = {
  ...
  invoice: { amount: '$2,860', due: 'Aug 15' },
...
export const RECENT_WINS = [
  { company: 'Palmetto Realty', value: '$2,970/mo', closedDaysAgo: 7 },
  { company: 'Sunbelt Landscaping', value: '$2,740/mo', closedDaysAgo: 14 },
  { company: 'Northgate Veterinary', value: '$1,980/mo', closedDaysAgo: 21 },
]

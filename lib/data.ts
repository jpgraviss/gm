...
export const appTasks: AppTask[] = [
  {
    id: 'at1',
    title: 'Follow up on Apex Solutions proposal — no response after 5 days',
    description: 'Send a second follow-up email and try to schedule a call. Mention the Q1 rate lock.',
    category: 'Deal',
    priority: 'High',
    status: 'Pending',
  ...
  {
    id: 'at2',
    title: 'Collect overdue invoice — Summit Capital INV-2024-006',
    description: 'Invoice is 12 days past due. Call finance contact and send formal notice.',
    category: 'Billing',
    priority: 'High',
    status: 'In Progress',
    company: 'Summit Capital',
    assignedTo: 'Tyler Ross',
    dueDate: '2026-03-01',
  ...
  {
    id: 'at3',
    title: 'Deliver wireframes to Coastal Realty — week 2 milestone',
    description: 'Jordan to send Figma link and schedule a review call by Tuesday.',
    category: 'Project',
    priority: 'High',
    status: 'In Progress',
  ...
  {
    id: 'at4',
    title: 'Send renewal proposal to ProVenture LLC — 12 days until expiry',
    description: 'Renewal is approaching. Prepare updated pricing and send proposal this week.',
    category: 'Renewal',
    priority: 'High',
    status: 'Pending',
    company: 'ProVenture LLC',
    assignedTo: 'Sarah Chen',
    dueDate: '2026-03-03',
  ...
  {
    id: 'at5',
    title: 'Schedule monthly review call with BlueStar Logistics',
    description: 'Monthly SEO performance call. Pull ranking report beforehand.',
    category: 'Project',
    priority: 'Medium',
    status: 'Pending',
  ...
  {
    id: 'at6',
    title: 'Invoice Coastal Realty for March maintenance',
    description: 'Generate recurring maintenance invoice for March billing cycle.',
    category: 'Billing',
    priority: 'Medium',
    status: 'Pending',
    company: 'Coastal Realty',
  ...
  {
    id: 'at7',
    title: 'Resolve ticket — Harvest Foods footer link broken',
    description: 'Email template CTA link is 404. Fix and resend corrected version.',
    category: 'Ticket',
    priority: 'Medium',
    status: 'In Progress',
  ...
  {
    id: 'at8',
    title: 'Send credentials deck to Meridian Healthcare',
    description: 'Include healthcare case studies and agency positioning. Follow up on proposal timeline.',
    category: 'Deal',
    priority: 'Medium',
    status: 'Pending',
  ...
  {
    id: 'at9',
    title: 'Update email automation sequence — Proposal Follow-Up timing',
    description: 'Adjust wait days from 3 to 2 days between step 1 and step 2 per review notes.',
    category: 'General',
    priority: 'Low',
    status: 'Pending',
  ...
  {
    id: 'at10',
    title: 'Prepare Q1 analytics report for BlueStar Logistics',
    description: 'Compile SEO rankings, traffic growth, and backlink acquisition for Q1. Present on March 15.',
    category: 'Project',
    priority: 'High',
    status: 'Pending',
    company: 'BlueStar Logistics',
  ...
  {
    id: 'at11',
    title: 'Summit Capital — kickoff meeting prep and agenda',
    description: 'Prep stakeholder map, project phases doc, and confirm team availability.',
    category: 'Project',
    priority: 'High',
    status: 'Completed',
    company: 'Summit Capital',
  ...
  {
    id: 'at12',
    title: 'Follow up with TechFlow Inc — 2 weeks of silence',
    description: 'Try a different channel — call instead of email. Reference the intro call notes.',
    category: 'Deal',
    priority: 'Low',
    status: 'Pending',
